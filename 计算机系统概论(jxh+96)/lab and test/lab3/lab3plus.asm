...
test    trap x20                  ;display the input of operate
        trap x21
loop    ld   r2,enter             ;load the minis hex number of enter
...
opemi   trap x20
        ...
        add  r4,r3,r0
        brz  test
        and  r4,r4, #0            ;judge the location fo r5 and r6, if r5 equals to r6, the structure is empty
        not  r4,r5
        add  r4,r4, #1
        add  r4,r6,r4
...
operi   trap x20
        ...
        add  r4,r3,r0
        brz  test
        and  r4,r4, #0            ;compare the location of r5 and r6, similar to minis mode
        not  r4,r5
        add  r4,r4, #1
        add  r4,r6,r4
        brz  addmr                ;if the structure is empty, branch to the add-to-output mode
...
mark   .fill x0000
back   .fill xfff8                ;store the minis of backspace
