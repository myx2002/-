...
int main()
{
	...
	for (first = 0;first <= again;first++)											//记录各行是否出现label 
	{
		...
		if ((input[first][second] == '\0')||
			...
			(input[first][0] == '.' && input[first][1] == 'O' && input[first][2] == 'R' && input[first][3] == 'I' && input[first][4] == 'G')||
			(input[first][0] == '.' && input[first][1] == 'F' && input[first][2] == 'I' && input[first][3] == 'L' && input[first][4] == 'L')||
			(input[first][0] == '.' && input[first][1] == 'B' && input[first][2] == 'L' && input[first][3] == 'K' && input[first][4] == 'W')||
		...
		else if (input[first][0] == 'B' && input[first][1] == 'R')
		{
			if((input[first][2]==' ')||(input[first][2]=='n' && input[first][3]=='z' && input[first][4]=='p' && input[first][5]==' ')||
				(input[first][2] == 'n' && input[first][3] == 'p' && input[first][4]==' ') || (input[first][2] == 'n' && input[first][3] == 'z' && input[first][4]==' ') ||
				(input[first][2] == 'z' && input[first][3] == 'p' && input[first][4]==' ') || (input[first][2] == 'z' && input[first][3]==' ') || 
				(input[first][2] == 'n' && input[first][3]==' ')||(input[first][2]=='p' && input[first][3]==' '))
				labeltable[first][0] = '\0';
			else
			{
	...
	for (first = 0;first <= again;first++)
	{
		...
		else if (input[first][second] == 'I' && input[first][second+1] == 'N' && input[first][second+2] == '\0')
			printf("1111000000100011\n");
		else if (input[first][second] == 'O' && input[first][second+1] == 'U' && input[first][second+2] == 'T' && input[first][second+3] == '\0')
			printf("1111000000100001\n");
		else if (input[first][second] == 'P' && input[first][second+1] == 'U' && input[first][second+2] == 'T' && input[first][second+3] == 'S' && input[first][second+4] == '\0')
			printf("1111000000100010\n");
		else if (input[first][second] == 'G' && input[first][second+1] == 'E' && input[first][second+2] == 'T' && input[first][second+3] == 'C' && input[first][second+4] == '\0')
			printf("1111000000100000\n");
		else if (input[first][second] == 'P' && input[first][second+1] == 'U' && input[first][second+2] == 'T' && input[first][second+3] == 'S' && input[first][second+4] == 'P' && input[first][second+5] == '\0')
...
void opfun(char array[300][50], int number, int second)
{
	...
	if (array[number][second] == 'O' && array[number][second + 1] == 'R' && array[number][second + 2] == 'I' && array[number][second + 3] == 'G')
	{
		...
		while (array[number][total] != '\0')
		{
			if (array[number][total] >= '0' && array[number][total] <= '9')
				receive = array[number][total] - '0'+ receive * 16;
			else if (array[number][total] <= 'F' && array[number][total] >= 'A')
				receive = array[number][total] - 'A' + 10 + receive * 16;
			total++;
		}
		trans(receive, 16, 1);
		printf("\n");
	...
	else if (array[number][second] == 'F' && array[number][second + 1] == 'I' && array[number][second + 2] == 'L' && array[number][second + 3] == 'L')
	{
		...
		else if (array[number][total - 1] == '#')
		{
			...
			while (array[number][total] != '\0' && array[number][total]!=' ')
			{
...
void anddfun(char input[300][50], int first, int second)
{
	...
	for (i = 1;i <= 2;i++)
		second = findr(input, first, second);
	while (!(input[first][second] == 'R' || input[first][second] == '#' || input[first][second] == 'x' || input[first][second]=='X'))
		second++;
	...
	else
	{
		...
		if (input[first][second] == '#')
			multi = 10;
		else if (input[first][second] == 'x' || input[first][second]=='X')
			multi = 16;
		second++;
		if (input[first][second] == '-')
		{
...
void ltdrfun(char input[300][50], int first, int second)						 
{
	int receive = 0;
	int multi=0;
	int flag = 1;
